  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid grid-rows-1 grid-cols-1 lg:grid-cols-12 gap-6">
        <Box className="!w-full shadow-md lg:col-span-4 bg-gradient-to-br from-blue-400 to-blue-600  text-gray-950 ">
          <CashierKpi />
        </Box>
        <Box
          className="!w-full shadow-md text-white bg-gradient-to-br from-[#18AB9D] to-[#34D399]  lg:col-span-4 cursor-pointer "
          onClick={() => navigate("/Appointmens/table")}
        >
          <TotalAppointmentsKpi />
          <LinechartKPI dataset={dataset} />
        </Box>
        <Box className="!w-full shadow-md bg-gradient-to-t from-[#E8FAFA] to-[#E6E6FA] text-gray-950 lg:col-span-4 ">
